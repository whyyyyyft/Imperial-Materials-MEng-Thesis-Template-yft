...
The distribution of error throughout k-space is notably non-uniform, with strong valleys between high-symmetry points for compressive strain and at the $\Gamma$-point for tensile strain. \red{need to do more research on this part}
...
Figure \ref{fig:vac} shows that DeepH is able to guess the presence of defect states in the bandgap, albeit not their position or quantity. Additionally, the shifts in the valence and conduction band are not accurately captured. 
